...
contextBridge.exposeInMainWorld("electron", {
  ...
  // ── TorrServer (Lampa) torrent-stream engine ───────────────────────────────
  torrPing: () => ipcRenderer.invoke("torrping"),
  torrList: () => ipcRenderer.invoke("torrlist"),
  torrAdd: (args) => ipcRenderer.invoke("torradd", args),
  torrAddFile: (args) => ipcRenderer.invoke("torradd-file", args),
  torrGet: (args) => ipcRenderer.invoke("torrget", args),
  torrRem: (args) => ipcRenderer.invoke("torrrem", args),
  torrStream: (args) => ipcRenderer.invoke("torrstream", args),
  torrExternal: (args) => ipcRenderer.invoke("torrexternal", args),
  torrSearch: (args) => ipcRenderer.invoke("torrsearch", args),
  torrSetCfg: (args) => ipcRenderer.invoke("torrset-cfg", args),
  torrGetCfg: () => ipcRenderer.invoke("torrget-cfg"),
  pickTorrentFile: () => ipcRenderer.invoke("torr-pick-file"),
