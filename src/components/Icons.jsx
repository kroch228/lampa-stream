...
// ── Watch Together mobile input bar + overlay icons ───────────────────────────
// Simple line icons matching the existing stroke style (viewBox 24, stroke 2).
...
// MicOffIcon: same mic body as MicIcon with a diagonal slash crossing it out.
// Line-stroke style matching MicIcon (viewBox 24, stroke 2, round caps/joins).
export const MicOffIcon = ({ size = 22 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// ── Picture-in-Picture (OnlinePlayer mobile) ─────────────────────────────────
// Outer screen (stroked) + inner floating window (filled), matching the
// line-stroke icon style (viewBox 24, stroke 2, round caps) used by MicIcon.
export const PiPIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="3" width="18" height="18" rx="2" />
    <rect x="11" y="11" width="8" height="8" rx="1" fill="currentColor" stroke="none" />
  </svg>
);
